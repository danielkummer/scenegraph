...
unsigned int TextureManager::createTexture(char *strFileName) {
	...
	unsigned int textureID = currTexIndex;
	currTexIndex++;
	...
	// End flipping
	/////////////////////////////////////////////////////////
	glGenTextures(1, &textures[textureID]);									// Generate a new texture ID
	glBindTexture(GL_TEXTURE_2D, textures[textureID]);						// Bind the texture (the following commands work with this texture)

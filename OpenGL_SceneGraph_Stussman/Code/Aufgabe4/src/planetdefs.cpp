...
//Planets
MercuryDef::MercuryDef():PlanetDef(0.382f, 6.13f, 0.0f, 0.39f, 0.24f, 0.0f, "Textures/Mercury.bmp"){}
VenusDef::VenusDef():PlanetDef(0.949f, -1.48f, 177.4f, 0.72f, 0.62f, 0.0f, "Textures/Venus.bmp"){}
